...
public class EnemySpawner : MonoBehaviour
{
    ...
    // A public static list of all active enemies
    ...
    private void SpawnEnemy()
    {
        ...
        GameObject enemyGO = Instantiate(prefabToSpawn, spawnPos, Quaternion.identity, enemiesParent);
        ...
        StartCoroutine(WaitForEnemyDestroy(enemyGO, enemyScript));
    }
    ...
    private IEnumerator WaitForEnemyDestroy(GameObject enemy, Enemy enemyScript)
    {
        while (enemy != null)
        {
            yield return null;
        ...
        // Remove from the active enemies list
        if (enemyScript != null)
        {
